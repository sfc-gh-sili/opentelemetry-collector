...
func newTracesRequest(td ptrace.Traces, pusher consumer.ConsumeTracesFunc) internal.Request {
...
func newTraceRequestUnmarshalerFunc(pusher consumer.ConsumeTracesFunc) exporterqueue.Unmarshaler[internal.Request] {
...
type RequestFromTracesFunc func(context.Context, ptrace.Traces) (internal.Request, error)
...
func requestFromTraces(pusher consumer.ConsumeTracesFunc) RequestFromTracesFunc {
	return func(_ context.Context, traces ptrace.Traces) (internal.Request, error) {
		return newTracesRequest(traces, pusher), nil
	}
}
...
func (tewo *tracesExporterWithObservability) send(ctx context.Context, req internal.Request) error {
